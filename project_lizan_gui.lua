-- Project lizan GUI script (ligmaXD)
-- Added by Kzan-art via Copilot

local msg = Instance.new("Message", workspace)
msg.Text = "Loading project lizan remake by goodRC7 and f0rkyk1dd"
wait(5.8)
msg:Destroy()
...
-- Change the execute button properties
execute.Name = "execute"
execute.Parent = Frame
execute.BackgroundColor3 = Color3.fromRGB(0, 0, 0) -- Set background color to black
execute.Position = UDim2.new(0.698806822, 0, 0.0863522813, 0)
execute.Size = UDim2.new(0, 75, 0, 200)
execute.Font = Enum.Font.SourceSans
execute.Text = "EXE"
execute.TextColor3 = Color3.fromRGB(255, 255, 255) -- Set text color to white
execute.TextSize = 14.000

-- Change the clear button properties
clear.Name = "clear"
clear.Parent = Frame
clear.BackgroundColor3 = Color3.fromRGB(0, 0, 0) -- Set background color to black
clear.Position = UDim2.new(0.698806822, 0, 0.550389409, 0)
clear.Size = UDim2.new(0, 75, 0, 176)
clear.Font = Enum.Font.SourceSans
clear.Text = "CLEAR"
clear.TextColor3 = Color3.fromRGB(255, 255, 255) -- Set text color to white
...
image.Image = "rbxassetid://95668700128315"
...
gcg.Name = "gcg"
gcg.Parent = Frame_2
gcg.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
gcg.Position = UDim2.new(0, 0, 0.120525256, 0)
gcg.Size = UDim2.new(0, 145, 0, 23)
gcg.Font = Enum.Font.SourceSans
gcg.Text = "Game Cursor Gui"
gcg.TextColor3 = Color3.fromRGB(0, 0, 0)
gcg.TextSize = 14.000

gguns.Name = "gguns"
gguns.Parent = Frame_2
gguns.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
gguns.Position = UDim2.new(0, 0, 0.0600222014, 0)
gguns.Size = UDim2.new(0, 145, 0, 23)
gguns.Font = Enum.Font.SourceSans
gguns.Text = "Gun Giver"
gguns.TextColor3 = Color3.fromRGB(0, 0, 0)
gguns.TextSize = 14.000

infyield.Name = "infyield"
infyield.Parent = Frame_2
infyield.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
infyield.Position = UDim2.new(0, 0, -0.000480814837, 0)
infyield.Size = UDim2.new(0, 145, 0, 23)
...
oneg.Name = "oneg"
oneg.Parent = Frame_2
oneg.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
oneg.Position = UDim2.new(0, 0, 0.181028321, 0)
oneg.Size = UDim2.new(0, 145, 0, 23)
oneg.Font = Enum.Font.SourceSans
oneg.Text = "1x1x1x1 Gui"
oneg.TextColor3 = Color3.fromRGB(0, 0, 0)
oneg.TextSize = 14.000

cmess.Name = "cmess"
cmess.Parent = Frame_2
cmess.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
cmess.Position = UDim2.new(0, 0, 0.241531447, 0)
cmess.Size = UDim2.new(0, 145, 0, 23)
cmess.Font = Enum.Font.SourceSans
cmess.Text = "c00l message"
cmess.TextColor3 = Color3.fromRGB(0, 0, 0)
...
ImageLabel.Image = "rbxassetid://95668700128315"
...
TextLabel_2.Text = "Project lizan Server Side ss execute Script"
...
local function OLFCRNW_fake_script() -- execute.execrip 
    ...
    script.Parent.MouseButton1Click:Connect(function()
        local scriptText = script.Parent.Parent.TextBox.Text
        if scriptText == "" then
...
local function XZQXAR_fake_script() -- infyield.iys 
    ...
    script.Parent.MouseButton1Click:Connect(function()
        ...
        if not success then
            warn("Error executing Admin: " .. err)
        end
    end)
end
...
local function MIKH_fake_script() -- fr6.1526 
    ...
    script.Parent.MouseButton1Click:Connect(function()
        -- Set the button to execute the given loadstring
        local command = loadstring(game:HttpGet("https://pastebin.com/raw/9BFcHqfK"))("Copyright SHON ECCS Co")
        if command then
            command()
        else
